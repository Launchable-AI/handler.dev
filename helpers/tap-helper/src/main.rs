//! handler-tap-helper: Minimal privileged helper for TAP device creation
//!
...
#[derive(Parser)]
#[command(name = "handler-tap-helper")]
...
enum Commands {
    ...
    Create {
        /// Name for the TAP device (e.g., "handler-tap0")
        #[arg(long)]
        name: String,
    ...
    SetupBridge {
        /// Name for the bridge (e.g., "handler-br0")
        #[arg(long)]
        name: String,
